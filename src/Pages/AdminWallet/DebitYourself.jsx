...
import { DoDebitYourSelf } from '../../services/AdminWallet';
...
const DebitYourself = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      var role = decryptValue(localStorage.getItem("serialtype"));
      ...
      const _result = await DoDebitYourSelf({
        data: requestdata
      });
    ...
    <div className="py-4 sm:py-6 md:py-8 bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-white transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 md:p-10">
          <h1 className="text-3xl font-bold mb-8 text-center text-blue-600 dark:text-blue-400">Debit Your self</h1>
