...
const SettledFailedPayinReport=()=> {
  ...
  const BindSettledPayinReport = async ({ dateRange: dateRange, selectedUser: selectedUser, selectedApi: selectedApi, searchValue: searchValue, currentPage: currentPage }) => {
    ...
    try {
      const _result = await GetsettledPayinReport({
        ...
        apiId: selectedApi, status: StatusEnum.Failed, search: searchValue, transactionTypeId: 0,
            ...
            <div className="overflow-x-auto rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-700">
                  <tr>
                    {['#', 'User Name', 'Company Name', 'Mobile No', 'Service Name', 'Date & Time', 'Status', 'Amount', 'RRN', 'Name', 'Account No', 'IFSC', 'UPI', 'Open', 'Surcharge', 'GST', 'Payable', 'Closed', 'Ref Id', 'Unique Id', 'Receipt', 'Complaint', 'Chargeback', 'Txn From', 'CallBack', 'Check Status', 'Fraud', 'IP Address', 'IP State', 'IP City'].map(header => (
...
export default SettledFailedPayinReport