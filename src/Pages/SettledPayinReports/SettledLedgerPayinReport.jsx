...
import { GetsettledPayinLedger, GetsettledPayinReport } from "../../services/SettledPayin";

const SettledLedgerPayinReport = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        BindPayinledgerReport({ dateRange: dateRange, selectedUser: selectedUser, selectedApi: selectedApi, searchValue: "", currentPage: currentPage });
      }
      catch (err) {
        Swal.fire("warning!", err.message, "warning");
      } finally {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 md:p-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <button
              onClick={() => BindPayinledgerReport({ dateRange, selectedUser, selectedApi, searchValue, currentPage })}
...
export default SettledLedgerPayinReport